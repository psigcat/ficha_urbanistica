...
class Const:
	...
	LINK_COND = u"<a href='file:///{:s}/condicions_generals.htm'>Condicions Generals</a>"
	LINK_DOT = u"<a href='file:///{:s}/dotacio_aparcament.htm'>Dotació mínima d'aparcaments</a>"
	LINK_REG = u"<a href='file:///{:s}/regulacio_aparcament.htm'>Regulació particular de l'ús d'aparcaments</a>"
	LINK_FINCA = u"<a href='file:///{:s}/param_finca.htm'>Paràmetres Finca</a>"
	LINK_EDIF = u"<a href='file:///{:s}/param_edificacio.htm'>Paràmetres Edificació</a>"
